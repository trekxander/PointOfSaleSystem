...
public class ProductMaintenance extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<pointofsalesystem.db.Product> toRemove = new ArrayList<pointofsalesystem.db.Product>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            pointofsalesystem.db.Product p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        pointofsalesystem.db.Product p = new pointofsalesystem.db.Product();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<pointofsalesystem.db.Product> merged = new ArrayList<pointofsalesystem.db.Product>(list.size());
            for (pointofsalesystem.db.Product p : list) {
    ...
    private java.util.List<pointofsalesystem.db.Product> list;
