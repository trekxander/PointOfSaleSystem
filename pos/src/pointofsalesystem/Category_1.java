 ...
 */
@Entity
@Table(name = "CATEGORY", catalog = "", schema = "APP")
@NamedQueries({
    ...
    @NamedQuery(name = "Category_1.findByName", query = "SELECT c FROM Category_1 c WHERE c.name = :name")})
public class Category_1 implements Serializable {
    ...
    public String toString() {
        return "pointofsalesystem.Category_1[ id=" + id + " ]";
    }
